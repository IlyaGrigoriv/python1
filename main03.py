...
# 1 Пользователь вводит число N – общее количество рассматриваемых дней (1 ≤ N ≤ 100).
...
n = 30  # int(input('Ввидите кольчество дней :  '))
list = []
# list [ for i in range(-50,50)]
for i in range(n):
...
print(f'Количество теплых дней подряд {itog}')
# работает
